...
#define LETRA_H  (SEGMENT_B | SEGMENT_C | SEGMENT_F | SEGMENT_E | SEGMENT_G )
#define LETRA_L  (SEGMENT_D | SEGMENT_E | SEGMENT_G )
...
static unsigned Hola[] = {LETRA_H, DIGIT_0, LETRA_L, DIGIT_A};
static unsigned EC[] = {DIGIT_E, DIGIT_C};
static unsigned anio[] = {DIGIT_2, DIGIT_0, DIGIT_1, DIGIT_8};
static unsigned Adios[] = {DIGIT_A, DIGIT_D, DIGIT_1, DIGIT_0, DIGIT_5};
